...
wget -c ftp://ftp.simplesystems.org/pub/libpng/png/src/libpng16/libpng-1.6.37.tar.gz 
## Downloading in directory of source code
...
cd $HOME/Build_WRF/LIBRARIES/src
