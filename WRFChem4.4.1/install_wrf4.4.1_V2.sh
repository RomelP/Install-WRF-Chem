...
cd  mpich-4.0.2/
FFLAGS=-fallow-argument-mismatch FCFLAGS=-fallow-argument-mismatch ./configure --prefix=$DIR/mpich
make -j4
make install
#----------------------------------------
# zlib
...
cd netcdf-c-4.9.2
CFLAGS=-fPIC CPPFLAGS='-I$DIR/hdf5/include -I$DIR/curl/include' 
LDFLAGS='-L$DIR/hdf5/lib -L$DIR/curl/lib' 
...
cd libpng-1.6.37
CPPFLAGS='-I$DIR/netcdf/include' FCFLAGS='-m64'
